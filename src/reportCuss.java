...
public class reportCuss extends javax.swing.JPanel {
    ...
    String sql = ("SELECT * from data.customer WHERE " + cmbCari.getSelectedItem().toString() + " LIKE '%" + txtSearch.getText() + "%'");
    ...
    private void initComponents() {
        ...
        cmbCari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID_Pelanggan", "Nama_Perusahaan", "Kontak_PIC", "Jabatan", "No_Telepon", "Email", "Bidang_Proyek" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cmbCari, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
