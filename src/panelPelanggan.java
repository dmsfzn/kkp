...
public class panelPelanggan extends javax.swing.JPanel {
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        StringBuilder barangDitambahkan = new StringBuilder("Barang berikut berhasil ditambahkan:\n");
        ...
        for (int i = 0; i < tblBarang.getRowCount(); i++) {
            ...
            if (isChecked != null && isChecked) {
                ...
                String nama = (String) tblBarang.getValueAt(i, 1); // Kolom 1: Nama
                int harga = Integer.parseInt(tblBarang.getValueAt(i, 2).toString());   // Kolom 2: Harga

                // Buat objek Barang dan tambahkan ke keranjang
                keranjangBelanja.add(new Barang(nama, harga));

                // Update pesan dan counter
                barangDitambahkan.append("- ").append(nama).append("\n");
                jumlahDitambahkan++;
            }
        }

        // Tampilkan pesan berdasarkan apakah ada barang yang ditambahkan
        if (jumlahDitambahkan > 0) {
            for (int i = 0; i < tblBarang.getRowCount(); i++) {
                tblBarang.setValueAt(false, i, 0); // Setel nilai checkbox di kolom 0 menjadi false
            }
